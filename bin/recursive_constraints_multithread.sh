#!/bin/bash
#! Name of the job:
#SBATCH -J multithread_recursive
#! Partition
#!SBATCH -p skylake
#! Number of tasks
...
#!Output file name
#SBATCH --output=Slurm/RecursiveMultiThreaded/R-%x.%j.out
#! Use default memory for now
#!SBATCH --mem-per-cpu=64G

source activate python38-env
srun python3 ./bin/find_independent_constraints_recursively_multithreaded.py 14
